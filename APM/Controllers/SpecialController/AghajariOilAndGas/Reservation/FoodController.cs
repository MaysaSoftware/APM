...
namespace APM.Controllers.SpecialController.AghajariOilAndGas.Reservation
{
    ...
    public class FoodController : Controller
    {
        ...
        public ActionResult Person()
        {
            ...
            foreach (DataRow row in Referral.DBData.SelectDataTable("SELECT  [شناسه],[عنوان]  FROM [وعده_غذایی]  where  [تاریخ_شروع_فعالسازی] <= N'" + CDateTime.GetNowshamsiDate() + "' and [تاریخ_پایان_فعالسازی] >= N'" + CDateTime.GetNowshamsiDate() + "' ").Rows )
            {
                MealList.Add(new SelectListItem() { Value=row[0].ToString(),Text=row[1].ToString() });
            }
        ...
        public JsonResult CheckReserve(long RecordID, string FromDate,string ToDate,long Restaurant,string SelectedMeal,string SelectedMealTitle,string SelectedDey,bool IsReserveBed)
        {
            //ViewData["RecordID"] = RecordID;
            //ViewData["FromDate"] = FromDate;
            //ViewData["ToDate"] = ToDate;
            ...
            DataTable MealData = Referral.DBData.SelectDataTable("Select * from وعده_غذایی");
            ...
            foreach (CoreObject ParameterCore in TableEventList)
            {
                ...
                { 
                    ...
                    string Alarm = Referral.DBData.SelectField(Query + "\n" + Tools.CheckQuery(Event.Query)).ToString();
                    if( Alarm !="")
                        return Json(Alarm);
        ...
        public ActionResult UpdateReservation(long RecordID)
        {
            DataTable ReserveData = Referral.DBData.SelectDataTable("Select * From درخواست_رزرو_غذا Where شناسه = " + RecordID.ToString());
            ViewData["RecordID"]=RecordID;
        ...
        public ActionResult UpdateChangeFood(long RecordID)
        {
            DataTable ReserveData = Referral.DBData.SelectDataTable("Select * From نفرات_رزرو_غذا Where شناسه = " + RecordID.ToString());
            ViewData["RecordID"]=RecordID; 
            return View("~/Views/SpecialForm/AghajariOilAndGas/Reservation/Food/ChangeFood.cshtml");
        }

        public ActionResult OfficeDepartmentAccountNumber([DataSourceRequest] DataSourceRequest _Request)
        {
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("شماره_حساب_واحد_سازمانی"), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }

        public ActionResult GetVehiclesOfficeDepartmentAccountNumber([DataSourceRequest] DataSourceRequest _Request, string FromDate = "", string ToDate = "", int OfficeDepartmentAccountNumber = 0, int Meal = 0)
        { 
            string Query = "Declare @نوع_دسترسی_کاربر as bigint =(SELECT  کاربر.نوع_دسترسی_کاربر FROM کاربر WHERE کاربر.شناسه = @شناسه_کاربر)  \n";
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("خودرو_قابل_دسترسی",Query), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }

        public ActionResult GetDriverOfficeDepartmentAccountNumber([DataSourceRequest] DataSourceRequest _Request, long Vehicle = 0)
        {
            string Query = "Declare @شناسه_خودرو as bigint = " + Vehicle + " \n"; 
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("راننده_خودرو", Query), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }

        public ActionResult GetAllOffice([DataSourceRequest] DataSourceRequest _Request)
        { 
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("لیست_کل_اداره_ها"), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
        public ActionResult PersonRestaurant([DataSourceRequest] DataSourceRequest _Request, string FromDate = "", string ToDate = "", int Meal = 0,int RequestType=1)
        {
            ...
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("رستوران_کاربر", Query), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
  
        public ActionResult ChangePersonFood([DataSourceRequest] DataSourceRequest _Request, string FromDate , long Restaurant, long Meal = 0)
        {
            string Query = "Declare @تاریخ as Nvarchar(255) = N'" + FromDate + "' \n";
            Query += "declare @رستوران  as bigint = " + Restaurant + " \n";  
            Query += "declare @وعده_غذایی  as bigint = " + Meal + " \n"; 

            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("تغییر_غذای_کاربر", Query), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
        public JsonResult SaveChangePersonFood([DataSourceRequest] DataSourceRequest _Request, long RecordID , long Restaurant, long Food)
        { 
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
            ...
            else
            {
                ...
                Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_ویرایش, PersonReservationTableCore, RecordID, CoulmnName, ColumnValue, "", PersonReservationTableCore.CoreObjectID.ToString());
                return Json("");
            }
        }
  
        public ActionResult PersonFood(string FromDate, string ToDate, int? Meal, int? Restaurant, [DataSourceRequest] DataSourceRequest _Request)
        {
            string Query = "Declare @از_تاریخ as Nvarchar(255) = N'" + FromDate + "' \n";
            Query += "Declare @تا_تاریخ as Nvarchar(255) = N'" + ToDate + "' \n";
            Query += "declare @وعده_غذایی  as bigint = " + Meal + " \n";
            ...
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("غذای_کاربر", Query), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
        public JsonResult GetPersonFood(string FromDate, string ToDate, int? Meal, int? Restaurant)
        {
            string Query = "Declare @از_تاریخ as Nvarchar(255) = N'" + FromDate + "' \n";
            Query += "Declare @تا_تاریخ as Nvarchar(255) = N'" + ToDate + "' \n";
            Query += "declare @وعده_غذایی  as bigint = " + Meal + " \n";
            ...
            var list = JsonConvert.SerializeObject(Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query)),
                                                    Formatting.None,
        ...
        public JsonResult SavePersonReservationFood(FormCollection form)
        {
            ...
            foreach(var MealItem in form.AllKeys)
            {
                if(MealItem.StartsWith("MealReservationFood"))
                {
                    ...
                    if(Restaurant>0&& Food>0)
                    {
                        ...
                        if (Referral.DBData.SelectDataTable(Tools.CheckQuery(Query)).Rows.Count == 0)
                ...
                else
                {
                    ...
                    { 
                        foreach (var food in FoodList)
                        {
                            ...
                            SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
                            Query += specialPhrase.Query;
                            string FoodValue = Referral.DBData.SelectField(Tools.CheckQuery(Query)).ToString();
                            food.Food = (FoodValue == "" ? 0 : int.Parse(FoodValue));
                            if(food.Food > 0)
                            Referral.DBData.Insert("رزرو_غذا"
                                , new string[] { "تاریخ_رزرو", "پرسنل_ثبت_کننده", "تاریخ_ثبت", "ساعت_ثبت", "رستوران", "نام_پرسنل_ثبت_کننده", "پرسنل", "وعده_غذایی", "غذا", "تعداد", "کاربر_ثبت_کننده" }
                                , new object[] { FromDate, Referral.UserAccount.PersonnelID, CDateTime.GetNowshamsiDate(), CDateTime.GetNowTime(), food.Restaurant, Referral.UserAccount.FullName, Referral.UserAccount.PersonnelID, food.Meal, food.Food, 1, Referral.UserAccount.UsersID }
        ...
        public ActionResult GetMeal([DataSourceRequest] DataSourceRequest _Request)
        {
            JsonResult jsonResult = Json(DataConvertor.FillSelectListWithQuery("وعده_غذایی_کاربر"), JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }
        public ActionResult GetRestaurantOfficeDepartmentAccountNumber(string FromDate, string ToDate, int OfficeDepartmentAccountNumber,int Meal, [DataSourceRequest] DataSourceRequest _Request)
        {
            ...
            SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore); 
            ListData = DataConvertor.ToSelectList(Referral.DBData.SelectDataTable(Tools.CheckQuery(specialPhrase.Query)));
            jsonResult = Json(ListData, JsonRequestBehavior.AllowGet);
            jsonResult.MaxJsonLength = int.MaxValue;
            return jsonResult;
        }

        public ActionResult GetPersonOfficeDepartmentAccountNumber([DataSourceRequest] DataSourceRequest _Request, string FromDate = "", string ToDate = "", int OfficeDepartmentAccountNumber = 0, int Meal = 0)
        {
            JsonResult jsonResult;
            SelectList ListData = new SelectList(new List<SelectListItem>() { new SelectListItem() { Value = "0", Text = "هیچکدام", Selected = true } }, "Value", "Text", 0);
            if(Session["PersonOfficeDepartment"] ==null)
            {
                ...
                SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
                ListData = DataConvertor.ToSelectList(Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query)));
        ...
        public JsonResult GetPersonInfo(string SearchValue,int RequestType=0, string FromDate = "", string ToDate = "", int Restaurant = 0, int Meal = 0, long RecordID = 0, string SelectedMeal = "", bool BedReservationFood = false)
        {
            ...
            SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
            DataTable PersonData = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query));
            ...
            if (RecordID>0)
            {
                ...
                if (ReserveData.Rows[0]["وعده_غذایی"].ToString() != SelectedMeal)
                {
                    ...
                    foreach (string OldMealItem in OldMeal)
                        ...
                        {
                            Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID+ " AND وعده_غذایی = "+ OldMealItem);
                        }  
                }
                ...
                if (Alarm != "")
                 ...
                 if(Referral.DBData.UpdateRow(ParentRowID, RequestReservationTableCore.CoreObjectID, RequestReservationTableCore.FullName, CoulmnName, ColumnValue))
                   Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_ویرایش, RequestReservationTableCore, ParentRowID, CoulmnName, ColumnValue, "", RequestReservationTableCore.CoreObjectID.ToString());

                if (string.Compare( ReserveData.Rows[0]["از_تاریخ"].ToString(), FromDate)==-1)
                { 
                    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND تاریخ_رزرو < N'" + FromDate+"'");
                } 
                if (string.Compare( ReserveData.Rows[0]["تا_تاریخ"].ToString(), ToDate)==1)
                { 
                    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND تاریخ_رزرو > N'" + ToDate + "'");
                } 
            }
            else
            { 
                ...
                if(ParentRowID>0)
                    Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_درج, RequestReservationTableCore, ParentRowID, CoulmnName, ColumnValue, "", RequestReservationTableCore.CoreObjectID.ToString());
            }
            ...
            foreach(string PersonGrid in GridJSON)
            {
                if(PersonGrid!="[]")
                {
                    ...
                    { 
                        ...
                        DataTable PersonReserve= Referral.DBData.SelectDataTable("select * FROM نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND تاریخ_رزرو <= N'" + FromDate + "' AND تاریخ_رزرو >= N'" + ToDate + "'");
                                                        ...
                                                        { 
                                                            ...
                                                            else
                                                            {
                                                               if(Referral.DBData.UpdateRow(long.Parse(Row["شناسه"].ToString()), PersonReservationTableCore.CoreObjectID, PersonReservationTableCore.FullName, CoulmnName, ColumnValue))
                                                                Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_ویرایش, PersonReservationTableCore, long.Parse(Row["شناسه"].ToString()), CoulmnName, ColumnValue, "", PersonReservationTableCore.CoreObjectID.ToString());
                                                            }
                                                        }
                                                    }
        ...
        public JsonResult SaveLetterReservationFood(string[] GridJSON,long RecordID=0, string FromDate = "", string ToDate = "", int RequestType=0, int OfficeDepartmentAccountNumber = 0,  string DateLetter = "",
                                                    ...
                                                    )
        {
            ...
            { 
                ...
                {
                    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID);
                }

                if (ReserveData.Rows[0]["رستوران"].ToString() != Restaurant.ToString())
                {
                    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID+ " and رستوران ="+ ReserveData.Rows[0]["رستوران"].ToString());
                }
            ...
            if(GridJSON!=null)
            {
                ...
                Referral.DBData.Execute(FinalQuery);
            }
            ...
            foreach (DataRow dataRow in BedData.Rows)
            {
                ...
                if (PersonnelID == "")
                {
                    if(dataRow["شماره_ملی"].ToString()!="")
                        PersonnelID = Referral.DBData.SelectField("Select شناسه from پرسنل where پرسنل.کد_ملی = N'" + dataRow["شماره_ملی"].ToString() + "'").ToString();
                    ...
                    if (PersonnelID == "" && dataRow["شماره_ملی"].ToString() != "")
                    {
                        ...
                        Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_درج, PersonCore, long.Parse(PersonnelID), PersonCoulmnName, PersonColumnValue, "", PersonCore.CoreObjectID.ToString());
                    }
                    else
                        PersonnelID = "-2";
                }
                ...
                if(long.Parse(dataRow["شناسه"].ToString()) > 0)
                {
                    ...
                    else
                    {
                       if(Referral.DBData.UpdateRow(long.Parse(dataRow["شناسه"].ToString()), BedTableCore.CoreObjectID, BedTableCore.FullName, BedCoulmnName, BedColumnValue))
                          Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_ویرایش, BedTableCore, long.Parse(dataRow["شناسه"].ToString()), BedCoulmnName, BedColumnValue, "", BedTableCore.CoreObjectID.ToString());
                    }
                }
                else
                { 
            ...
            Referral.DBData.Execute("Update  درخواست_رزرو_غذا set نفرات = N'"+PersonName+"' where شناسه = "+ ParentRowID);
            return Json(new { Message = ErrorMessage, RecordID = ParentRowID });
        ...
        public JsonResult SaveDelayedReservationFood(long RecordID=0, string FromDate = "", string ToDate = "", int RequestType=0, long Restaurant=0,int OfficeDepartmentAccountNumber = 0,long ForOffice = 0,string Message="",  string GridJSON = "")
        {
            CoreObject RequestReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "درخواست_رزرو_غذا");
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا"); 
            ...
            if(ParentRowID>0)
            { 
                DataTable DayData = Referral.DBData.SelectDataTable("Select * from لیست_تاریخ where تاریخ_شمسی>=N'" + FromDate + "' and تاریخ_شمسی <=N'" + ToDate + "' and وضعیت_روز_کاری = 1 ");
                string Query = "Declare @از_تاریخ as Nvarchar(255) = N'" + FromDate + "' \n";
                Query += "Declare @تا_تاریخ as Nvarchar(255) = N'" + ToDate + "' \n";
                Query += "declare @مکان  as bigint = " + Restaurant + " \n";
                ...
                DataTable MealProgram = Referral.DBData.SelectDataTable(Query);
                string DefualtFood = "";
                string FinalQuery = "";
                ...
                else
                {
                    ...
                    {
                        DataTable PersonReserveDate = Referral.DBData.SelectDataTable("Select تاریخ_رزرو from نفرات_رزرو_غذا where درخواست_رزرو_غذا = "+ RecordID+" and پرسنل = "+ dataRow1["شناسه"].ToString()+ " group by تاریخ_رزرو");
                        foreach (DataRow DayRow in DayData.Rows)
                        {
        ...
        public JsonResult SaveShiftReservationFood(long RecordID = 0, string FromDate = "", string ToDate = "", int RequestType = 0, int ShiftChangeDay = 0, long Restaurant = 0, int OfficeDepartmentAccountNumber = 0, string Message = "", string GridJSON = "", string BedGridJSON = "", string SelectedMeal = "", string SearchOfReserveID = "")
        {
            CoreObject RequestReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "درخواست_رزرو_غذا");
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
            CoreObject BedTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "پذیرش_مهمانسرا");
            ...
            {
                Referral.DBData.Execute("Delete نفرات_رزرو_غذا where نفرات_رزرو_غذا.درخواست_رزرو_غذا = " + SearchOfReserveID + " and نفرات_رزرو_غذا.تاریخ_رزرو>=N'" + ToDate + "' AND تاریخ_رزرو <= N'" + ToDate + "' ");
            }

            DataTable ReserveData = Referral.DBData.SelectDataTable("Select * From درخواست_رزرو_غذا Where شناسه = " + RecordID.ToString()); 
            DataTable PersonData = Referral.DBData.SelectDataTable("Select پرسنل from نفرات_رزرو_غذا where تاریخ_رزرو >= N'" + FromDate + "'  AND تاریخ_رزرو <= N'" + ToDate + "'  And درخواست_رزرو_غذا =" + RecordID + " And پرسنل >0  group by پرسنل");
            string FinalQuery = "";
            ...
            if (RecordID > 0)
            {
                if (ReserveData.Rows[0]["وعده_غذایی"].ToString() != SelectedMeal && ReserveData.Rows[0]["وعده_غذایی"].ToString() != "")
                {
                    ...
                    foreach (string OldMealItem in OldMeal)
                        ...
                        {
                            Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND وعده_غذایی = " + OldMealItem + " AND تاریخ_رزرو >= N'" + FromDate + "'");
                            Referral.DBData.Execute("Delete وعده_های_رزرو_شده_نوبتکار Where  درخواست_رزرو_غذا=" + RecordID + " AND وعده_غذایی = " + OldMealItem);
                        }
                }
                else if (ReserveData.Rows[0]["وعده_غذایی"].ToString() != SelectedMeal && SelectedMeal == "") 
                    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND تاریخ_رزرو >= N'" + FromDate + "'"); 
                ...
                //if (string.Compare(ReserveData.Rows[0]["از_تاریخ"].ToString(), FromDate) == -1) 
                    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND تاریخ_رزرو >= N'" + FromDate + "' AND تاریخ_رزرو <= N'" + ToDate + "'"); 
                //if (string.Compare(ReserveData.Rows[0]["تا_تاریخ"].ToString(), ToDate) == 1) 
                //    Referral.DBData.Execute("Delete نفرات_رزرو_غذا Where  درخواست_رزرو_غذا=" + RecordID + " AND تاریخ_رزرو > N'" + ToDate + "'");
            ...
            DataTable AdminPersonData = Referral.DBData.SelectDataTable("Select * from نفرات_رزرو_غذا where تاریخ_رزرو >= N'" + FromDate + "'  and تاریخ_رزرو <=N'" + ToDate + "'   And درخواست_رزرو_غذا =" + RecordID + " And پرسنل = -2  ");
            DataTable DayData = Referral.DBData.SelectDataTable("Select * from لیست_تاریخ where تاریخ_شمسی>=N'" + FromDate + "' and تاریخ_شمسی <=N'" + ToDate + "'");
            string Query = "Declare @از_تاریخ as Nvarchar(255) = N'" + FromDate + "' \n";
            Query += "Declare @تا_تاریخ as Nvarchar(255) = N'" + ToDate + "' \n";
            Query += "declare @مکان  as bigint = " + Restaurant + " \n";
            ...
            if (RecordID == 0)
            {
                foreach (DataRow MealRow in MealData.Rows)
                {
                    ...
                    Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_درج, ShiftMeal, RowID, CoulmnName, ColumnValue, "", ShiftMeal.CoreObjectID.ToString());
            ...
            else
            {
                ...
                foreach (DataRow MealRow in MealData.Rows)
                {
                    ...
                    if (long.Parse( MealRow["شناسه"].ToString()) > 0)
                    {
                        ...
                        Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_ویرایش, ShiftMeal, long.Parse(MealRow["شناسه"].ToString()), CoulmnName, ColumnValue, "", ShiftMeal.CoreObjectID.ToString());
                    }
                    else
                    {
                        Alarm = Desktop.CheckBeforRunQuery(ShiftMeal.CoreObjectID,0, CoreDefine.TableEvents.شرط_اجرای_درج, CoulmnName, ColumnValue);
                ...
                try
                {
                    if(BedData.Columns.IndexOf("تخت") > -1)
                        ...
                        { 
                            ...
                            {
                                Referral.DBData.Execute("Update پذیرش_مهمانسرا set تا_تاریخ = N'" + ToDate + "' where رزرو_غذا =" + RecordID + " and پرسنل =" + dataRow["شناسه"]);
                            }
                        }
            ...
            Referral.DBData.Execute("Update درخواست_رزرو_غذا set نفرات =N'"+ PesrsonName + "' where شناسه = " + RecordID);
            return Json(new { Message = ErrorMessage, RecordID = ParentRowID }); 
        }

        public ActionResult ReadMealLetter([DataSourceRequest] DataSourceRequest _Request,long RecordID=0, string Date = "", long Restaurant = 0, string Meal = "", bool IsSharingFood=true, string DefualtFoodCount="")
        {
            ...
            { 
                ...
                Query += "\nand رستوران = @رستوران";
                    ...
                    dataTable = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query));
                    if (MealId.Length > 0 && string.Compare(Date, CDateTime.GetNowshamsiDate()) > -1)
                    {
            ...
            else
            {
                ...
                Session["MealLetter" + Date.Replace("/", "") + Restaurant + Meal] = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query));
                //}
        ...
        public JsonResult UpdateLetterMealFood(long RecordID,int CountReservationFood)
        {
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
        ...
        public JsonResult RemoveLetterMealFood(long RecordID)
        {
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
            ...
            else
            {
                ...
                {
                    Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_حذف, PersonReservationTableCore, RecordID, new string[] { }, new object[] { }, "", PersonReservationTableCore.CoreObjectID.ToString()); 
                    return Json("");
                }
                return Json("ذخیره سازی با شکست مواجه شد");
            }
        }
        public JsonResult RemoveLetterMealFoodWithDate(long RecordID,string Date)
        {
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
            DataTable MealReserveData = Referral.DBData.SelectDataTable("Select شناسه From نفرات_رزرو_غذا Where درخواست_رزرو_غذا = "+RecordID+ " And تاریخ_رزرو = N'"+Date+"'");
            foreach(DataRow Row in MealReserveData.Rows)
            {
                ...
                else
                {
                    if (Referral.DBData.Delete(PersonReservationTableCore.FullName, long.Parse(Row["شناسه"].ToString()))) 
                        Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_حذف, PersonReservationTableCore, long.Parse(Row["شناسه"].ToString()), new string[] { }, new object[] { }, "", PersonReservationTableCore.CoreObjectID.ToString()); 
                    else
                        return Json("ذخیره سازی با شکست مواجه شد");
                }
            }
        ...
        public ActionResult ReadPerson(string RequestType, bool IsReload, [DataSourceRequest] DataSourceRequest _Request)
        {
            ...
            if(Session[RequestType]==null||IsReload)
            {
                ...
                CoreObject SpecialPhraseCore = CoreObject.Find(CoreDefine.Entities.عبارت_ویژه, specialPhraseName);
                SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
                Session[RequestType] = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query));
            }
        ...
        public ActionResult ReadMealShift(long RecordID, string Meals,string SearchOfReserveID, [DataSourceRequest] DataSourceRequest _Request)
        { 
            JsonResult jsonResult = new JsonResult();
            ...
            else if (RecordID == 0 && SearchOfReserveID != "")
            {
                ...
                SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
                MealData = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query));
                string[] MealArr = Meals.Split('_');
        ...
        public JsonResult RemoveShiftMealGrid(long ParentID, string FromDate, string ToDate, long RecordID, int Meal)
        {
            DataTable PersonData = Referral.DBData.SelectDataTable("Select شناسه From نفرات_رزرو_غذا Where  درخواست_رزرو_غذا =" + ParentID + "  And  وعده_غذایی =" + Meal);
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
            CoreObject ShiftMealTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "وعده_های_رزرو_شده_نوبتکار");
            string Alarm = string.Empty;
            foreach (DataRow row in PersonData.Rows)
            ...
            else
            {
                if (Referral.DBData.Delete(ShiftMealTableCore.FullName, RecordID))
                    Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_حذف, ShiftMealTableCore, RecordID, new string[] { }, new object[] { }, "", ShiftMealTableCore.CoreObjectID.ToString());
            }

            return Json("");
        }

        public ActionResult ReadPersonShift([DataSourceRequest] DataSourceRequest _Request, long RecordID = 0  )
        { 
            JsonResult jsonResult = new JsonResult(); 
            ...
            { 
                ...
                SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
                PersonData = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query));  
            }
        ...
        public JsonResult RemoveShiftPersonGrid(long ParentID,long RecordID,bool Bed,string FromDate="",string ToDate="")
        {
            ...
            //{ 
            //    FromDate = CDateTime.GetNowshamsiDate();
            //    //Referral.DBData.Execute("Delete نفرات_رزرو_غذا where  درخواست_رزرو_غذا =" + ParentID + "  And پرسنل = " + RecordID + " And تاریخ_رزرو >= N'" + FromDate + "' and تاریخ_رزرو <= N'" + ToDate + "'");
            ...
            //    DataTable PersonData = Referral.DBData.SelectDataTable("Select شناسه From پذیرش_مهمانسرا Where  رزرو_غذا = " + ParentID + " And  پرسنل = " + RecordID );
        ...
        public ActionResult ReadReservationFood([DataSourceRequest] DataSourceRequest _Request, long RecordID = 0,string Date="",string SelectedMeal="",long Restaurant=0 )
        { 
            JsonResult jsonResult = new JsonResult(); 
            DataTable MealData=new DataTable(); 
            if(RecordID>0)
            {
                ...
                if(SelectedMeal=="" && (bool)ReserveData.Rows[0]["وضعیت_رزرو_تخت"]==true)
                {
                    ...
                    MealData = Referral.DBData.SelectDataTable(Query);
                }
        ...
        public JsonResult UpdateOfficeReservationFood(long ParentID,string FromDate,long Person,string Meal,string MealValue)
        {
            string Query = string.Empty;
            ...
            if (Meal.IndexOf("GridMealReservationFood")>-1)
            {
                ...
                string ID = Referral.DBData.SelectField(Query).ToString();
                if (ID != "")
                {
                    ...
                    if (MealValue == "false")
                    {
                        ...
                        else
                        {
                            if (Referral.DBData.Delete(PersonReservationTableCore.FullName,long.Parse(ID)))
                                Desktop.AfterRunQuery(CoreDefine.TableEvents.دستور_بعد_از_حذف, PersonReservationTableCore, long.Parse(ID), CoulmnName, ColumnValue, "", PersonReservationTableCore.CoreObjectID.ToString());
                        }
                    } 
                }
        ...
        public JsonResult RemoveRowOffice(long RecordID,long Person,string Date,bool Bed)
        {
            try
            { 
                CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
                DataTable PersonData = Referral.DBData.SelectDataTable("Select شناسه From نفرات_رزرو_غذا Where درخواست_رزرو_غذا = " + RecordID + " And  پرسنل = " + Person + " And تاریخ_رزرو =N'" + Date + "'");
                ...
                if (Bed == true)
                {
                    ...
                    PersonData = Referral.DBData.SelectDataTable("Select شناسه From پذیرش_مهمانسرا Where  رزرو_غذا = " + RecordID + " And  پرسنل = " + Person + " And  N'" + Date + "' Between از_تاریخ And تا_تاریخ");
        ...
        public JsonResult RemoveDelayedPerson(long RecordID,long Person)
        {
            try
            { 
                CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "نفرات_رزرو_غذا");
                DataTable PersonData = Referral.DBData.SelectDataTable("Select شناسه From نفرات_رزرو_غذا Where درخواست_رزرو_غذا = " + RecordID + " And  پرسنل = " + Person );
        ...
        public ActionResult ReadDelayedReservationFood([DataSourceRequest] DataSourceRequest _Request, long RecordID = 0)
        {
            JsonResult jsonResult = new JsonResult();
            ...
            if (RecordID > 0)
            {
                ...
                SpecialPhrase specialPhrase = new SpecialPhrase(SpecialPhraseCore);
                PersonBedData = Referral.DBData.SelectDataTable(Tools.CheckQuery(Query + specialPhrase.Query));
            }
        ...
        public ActionResult ReadBedReservationFood([DataSourceRequest] DataSourceRequest _Request, long RecordID = 0)
        {
            JsonResult jsonResult = new JsonResult();
            DataTable PersonBedData = new DataTable();
            if (RecordID > 0)
        ...
        public JsonResult RemoveLetterBed(long RecordID)
        {
            CoreObject PersonReservationTableCore = CoreObject.Find(Referral.MasterDatabaseID, CoreDefine.Entities.جدول, "پذیرش_مهمانسرا");  
            string Alarm = Desktop.CheckBeforRunQuery(PersonReservationTableCore.CoreObjectID, RecordID, CoreDefine.TableEvents.شرط_اجرای_حذف, new string[] { }, new object[] { });
            if (Alarm != "")
