    ...
    public class SQLDataBase
    {
        ...
        public partial class ConnectionDataClass
        {
            ...
            public string ConnectionString
            {
                get
                {
                    return "Password=" + DBPassword + ";Persist Security Info=True;Data Source=" + Source + ";Integrated Security=False;; Enlist=false; Initial Catalog=" + DataBase + ";User ID=" + DBUser; // Connect timeout=15;
                }
            }
